  ...
  return (
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
      ...
      md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30'>
        <div className='flex flex-col md:items-start items-center w-full'>
          ...
          <p className='mt-6 text-center md:text-left text-sm text-white/80'>Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Ea optio, eaque cupiditate et fuga non reiciendis deleniti 
            ad incidunt nostrum excepturi
            </p>
        </div>
      </div>
      <div className='flex flex-col md:items-start items-center w-full'>
      ...
      <div className='hidden md:flex flex-col items-start w-full'>
        ...
        <p className='text-sm text-white/80'>The latest news, articles and resources are available here</p>
      ...
      <p className='py-4 text-center text-xs md:text-sm text-white/60'>copyrigth &copy; 2025 Kalala27. All rights reserved.</p>
    </footer>
  )
}
