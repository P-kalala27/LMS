...
const Footer = () => {
  return (
    <footer className='flex md:flex-row flex-col-reverse items-center justify-between text-leftw-full px-8 border-t '>
      ...
      <div className='flex items-center gap-4'>
        ...
        <p className='py-4 text-center text-xs
         md:text-sm text-gray-500'>Copyright 2025 @copy; Jean-Paul . All Right Reserved</p>
      </div>
