...
const Dashboard = () => {
  const [dahsboardData, setDashboardData] = useState(null)
    ...
    md:pb-0 p-4 pt-8 pb-0'>
      <div className='space-y-5'>
          ...
          p-4 w-56 rounded-md'>
            ...
            <div>
              <p className='text-2xl font-medium text-gray-600'>
                {currency}{dahsboardData.totalEarnings}
              </p>
         ...
         rounded-md bg-white border border-gray-500/20'>
          ...
          <table className='table-fixed md:table-auto w-full overflow-hidden'>
            ...
            <tbody className='text-sm text-gray-500'>
              {
                dahsboardData.enrolledStudentsData.map((student, index) => (
